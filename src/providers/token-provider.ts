...
export const BNBS_ROOTSCTOCK = new Token(
  ChainId.ROOTSTOCK,
...
export const RDAI_ROOTSCTOCK = new Token(
  ChainId.ROOTSTOCK,
...
export const RUSDC_ROOTSCTOCK = new Token(
  ChainId.ROOTSTOCK,
